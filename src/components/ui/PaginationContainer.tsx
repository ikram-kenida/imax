    ...
    for (let i = startPage; i <= endPage; i++) {
      ...
      pageNumbers.push(
        <PaginationItem key={i}>
          ...
          >
            <span className="text-blue-600 text-base font-medium leading-none tracking-wide">
              {i}
            </span>
          </Button>
        </PaginationItem>
      ...
      <PaginationContent>
        <PaginationItem className="md:block hidden">
          <Button
            ...
            className="w-[122px] h-10 p-2 gap-2 group"
          ...
          >
            ...
            <span className="text-blue-600 group-disabled:text-zinc-500 text-base font-medium leading-none tracking-wide">
              Previous
            </span>
          </Button>
        </PaginationItem>
